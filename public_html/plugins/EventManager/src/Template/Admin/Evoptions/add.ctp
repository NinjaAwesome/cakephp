                    ...
                    <div class="tab-pane active" id="categories">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <?php echo $this->Form->input('option_type', ['options' => Configure::read("OptionsType"), 'class' => 'form-control', 'label' => false]); ?>
                                </div>
                            </div>
                        </div><!-- /.form-group -->
                    ...
                    <table id="option-value" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            if (!empty($option->evoption_values)) {
                                foreach ($option->evoption_values as $opv) {
                                    ...
                                    <tr id="option-value-row<?php echo $autoInc; ?>">
                                        <td>
                                            <?php
                                            echo $this->Form->input('evoption_values.' . $option_value_row . '.title', ['class' => 'form-control', 'placeholder' => __('Option Value Name'), 'label' => false]);
                                            echo $this->Form->input('evoption_values.' . $option_value_row . '.id', ['type' => 'hidden']);

                                            ?>
                                        </td>
                                        <td><?php echo $this->Form->input('evoption_values.' . $option_value_row . '.sort_order', ['class' => 'form-control', 'placeholder' => __('Sort Order'), 'label' => false]); ?></td>
                                        <td class="text-left">
                                            <?php
                                            if (!empty($opv->id)) {
...
function addOptionValue() {
    ...
    html += '<td>';
    html += '<input name="evoption_values['+option_value_row+'][title]" class="form-control" placeholder="Option Value Name" type="text">';
    html += '</td>';
    html += '<td>';
    html += '<input name="evoption_values['+option_value_row+'][sort_order]" class="form-control" placeholder="Sort Order" type="number">';
    html += '</td>';
