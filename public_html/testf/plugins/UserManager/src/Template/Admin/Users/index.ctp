                            ...
                            if (!empty($users->toArray())):
                                ...
                                foreach ($users as $user):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if (!empty($user->profile_photo) && file_exists(WWW_ROOT ."img/". $user->profile_photo)) {
                                                echo $this->Glide->image($user->profile_photo, ['w'=>'50', 'h'=>'50','fit'=>'fill']);
                                            }else{
                                        ...
                                        <td class="actions">
                                            <div class="form-group">
                                                ...
                                                <?php /* <?= $this->Html->link("<i class=\"fa fa-edit\"></i>", ['action' => 'add', $user->id], ['class' => 'btn btn-primary btn-sm btn-flat', 'escape' => false, 'data-toggle' => 'tooltip', 'alt' => __('Edit user'), 'title' => __('Edit user')]) ?> */?>
