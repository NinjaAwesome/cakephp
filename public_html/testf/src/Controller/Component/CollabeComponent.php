...
//        die;
        switch($flines.'-'.$lines){
            case "1-1": /*top one line, bottom one line */
                $th = $th;
                $bh = $bh;
                break;
            case "2-2": /*top two line, bottom two line */
                $th = 220;
                $bh = $bh+30;
                $mh = $mh-15;
                break;
            case "3-3": /*top three line, bottom thee line */
                $th = $th+60;
                $bh = $bh+120;
                $mh = $mh;
                break;
            case "1-2": /*top one line, bottom two line */
                $th = $th+20;
                $bh = $bh+00;
                $mh = $mh-50;
                break;
            case "2-1": /*top two line, bottom one line */
                $th = $th+10;
                $bh = $bh-10;
                $mh = $mh+10;
                break;
            case "3-1": /*top three line, bottom one line */
                $th = $th-0;
                $bh = $bh+0;
                $mh = $mh+20;
                break;
            case "1-3": /*top one line, bottom three line */
                $th = $th+90;
                $bh = $bh+10;
                $mh = $mh-120;
                break;
            case "2-3":/*top two line, bottom three line */
                $th = $th+100;
                $bh = $bh+50;
                $mh = $mh-80;
                break;
            case "3-2":/*top three line, bottom two line */
                $th = $th-20;
                $bh = $bh+80;
                $mh = $mh+40;
                break;
...
//        if($flines == 1 && $lines == 1) { 
//            
//        }else if($flines == 2 && $lines == 2) { 
//            
//        }else if($flines == 3 && $lines == 3) { 
//            
//        }else if($flines == 1 && $lines == 2) { 
//            
//        }else if($flines == 2 && $lines == 1) { 
//            
...
//        }   
       ...
       /* list($logo_width, $logo_height) = getimagesize($logoPath);
        ...
        imagecopymerge($image, $src, $dst_x-40, $dst_y-20, 0, 0, $logo_width, $logo_height, 100); 
