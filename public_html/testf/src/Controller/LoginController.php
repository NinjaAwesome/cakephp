...
class LoginController extends AppController
{
    ...
    var $instagram_settings = [
        ...
        'apiCallback' => 'https://collabthem.com/testf/login?provider=instagram'
    ];
    ...
    public function index()
    {
        ...
        $loginUrl = $helper->getLoginUrl('https://collabthem.com/testf/login', $permissions);
        ...
        else
        {
            ...
            $request_token = $connection->oauth('oauth/request_token', array('oauth_callback' => "https://collabthem.com/testf/login"));
